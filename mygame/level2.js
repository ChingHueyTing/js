class level2 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("pink1", "assets/pink.png", {
      frameWidth: 64,
      frameHeight: 64,
    });
    this.load.spritesheet("pink2", "assets/pink.png", {
      frameWidth: 64,
      frameHeight: 64,
    });
  } // end of preload //
  ...
  let pink1 = map.findObject("objectLayer", (obj) => obj.name === "pink1")
  let pink2 = map.findObject("objectLayer", (obj) => obj.name === "pink2")

  
    //Add main player here with physics.add.sprite
    this.enemy1 = this.physics.add.sprite(432, 263, "enemy1");
...
this.heart3.setDepth(1); // Set the depth to 1 (or higher if needed) to render it on top
  ...
  this.physics.add.overlap(this.player, this.yellow1, this.collectYellow1, null, this);
  this.physics.add.overlap(this.player, this.yellow2, this.collectYellow2, null, this);
  this.physics.add.overlap(this.player, this.yellow3, this.collectYellow3, null, this);
  this.physics.add.overlap(this.player, this.yellow4, this.collectYellow4, null, this);
  this.physics.add.overlap(this.player, this.yellow5, this.collectYellow5, null, this);
  this.physics.add.overlap(this.player, this.pink1, this.collectPink1, null, this);
  this.physics.add.overlap(this.player, this.pink2, this.collectPink2, null, this);
  ...
  update() {
      ...
      // In update()
   if (this.player.x > 920 && this.player.y > 270 && this.player.y < 393) {
    console.log("Door2");
    this.room2();
  }
...
hitEnemy7(player, item) {
  console.log("Player hit enemy7"); // Add this line
  this.cameras.main.shake(200);
  item.disableBody(true, true);
  ...
  collectPink2(player, item) {
    console.log("player collect pink2")
    item.disableBody(true, true)
    this.score += 2;
    this.scoreText.setText('Energy Drink:' + this.score);
    return false
