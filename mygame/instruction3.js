...
class instruction3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('instruction3', 'assets/instruction03.jpg');
    }

    create() {
        // Display the instruction image
        const instructionImg = this.add.image(0, 0, 'instruction3');
        ...
        // Listen for the spacebar press to start instruction4
        this.input.keyboard.on('keydown-SPACE', function () {
            console.log("Spacebar pressed, goto instruction4");
            this.scene.start('instruction4');
        }, this);
    }
}
